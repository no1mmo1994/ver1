# LadiPage Handoff - MTRAVLIXENTORX LLC

This folder contains everything needed to rebuild the current landing page inside LadiPage builder.

## Files

- `CONTENT_MAP.md`: section-by-section copy and structure
- `STYLE_GUIDE.md`: colors, typography, spacing, button style
- `FORM_AND_CTA.md`: form fields, CTA links, and contact actions
- `assets/`: logo and visual files

## Assets

- `assets/mtravlixentorx-logo.svg` (company logo)
...
2. Upload `mtravlixentorx-logo.svg` and set it for header logo and footer logo.
...
6. Publish and test all call/email/WhatsApp actions on mobile.
